...
<div
	class="relative bg-white border border-slate-200/30 dark:bg-slate-200 rounded-xl h-52 sm:h-52 shadow-sm hover:shadow-lg shadow-neutral-100 p-4 m-4 mb-4 lg:w-96"
>
